...
// ============================================
// POSTS — tek akış, üç etiket: gundem / gunluk / gorus
// projectId: ilgili proje (gunluk/gorus için), null olabilir
// source: gundem yazıları için kaynak künyesi
// ============================================
const posts = [
  {
...
const postsForProject = (projectId) => posts.filter(p => p.projectId === projectId);
...
Object.assign(window, {
  translations, people, startups, posts, sponsors, events,
  teamMembers, mentors, partners, siteStats, resolveStat, SH_DEFAULTS,
