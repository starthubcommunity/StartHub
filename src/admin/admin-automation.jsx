...
function AutomationPage() {
  ...
  // "Onayla" ile birlikte LinkedIn'e de paylaş — asıl paylaşımı Make.com senaryosu
  // posts.linkedin_share alanını izleyerek yapıyor, burada sadece o bayrak yönetiliyor.
  const [draftLinkedinFlags, setDraftLinkedinFlags] = useState({}); // {draftId: bool}
